...
export default function PoliceSettings() {
    ...
    return (
        <div className="mx-auto flex h-full w-full max-w-4xl flex-col items-start gap-6 p-4">
            ...
            <div className="w-full rounded-3xl border border-gray-200 dark:border-slate-800 bg-white dark:bg-slate-950/70 p-8 shadow-xl shadow-gray-200 dark:shadow-black/20">
                ...
                <form onSubmit={handleSubmit} className="space-y-6 max-w-xl">
                    <div>
                        ...
                        <input
                            ...
                            required
                            className="w-full border border-gray-300 dark:border-slate-700 p-3 rounded-xl bg-gray-50 dark:bg-slate-900/50 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-sky-500 transition-colors"
                        />
                    </div>
                    ...
                    <div className="pt-4">
                        <button
                            type="submit"
                            disabled={loading}
                            className="rounded-xl bg-sky-600 px-6 py-3 text-sm font-bold text-white transition hover:bg-sky-700 disabled:bg-sky-400 disabled:cursor-not-allowed"
                        >
